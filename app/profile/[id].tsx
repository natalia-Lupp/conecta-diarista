  ...
  if (!diarista) {
    return (
      <SafeAreaView style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
        <Text style={{ fontSize: 18, color: colors.muted }}>Carregando informações...</Text>
      </SafeAreaView>
    );
  }
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.imageContainer}>
            <Image
              ...
              style={[styles.foto, bloqueada && { tintColor: "#888", opacity: 0.5 }]}
            />
            {bloqueada && <Text style={styles.overlayText}>🚫 Usuária bloqueada</Text>}
          </View>
          ...
          {/* Botão contratar */}
          <TouchableOpacity
            style={[styles.botaoContato, bloqueada && { backgroundColor: "#777" }]}
            onPress={openActionSheet}
          >
            <Text style={styles.textoBotao}>
              {bloqueada ? "Usuária bloqueada (desbloquear)" : "Quero Contratar"}
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
      ...
      <View style={styles.menuInferior}>
        ...
        <TouchableOpacity style={styles.menuBotao} onPress={() => alert("Usuário saiu!")}>
